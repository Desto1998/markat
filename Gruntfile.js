        ...
        uglify: {
            my_target: {
                files: {
                    ...
                    'assets/js/filterDropDown.min.js': ['assets/js/filterDropDown.js'],
        ...
        replace: {
            ...
            maps_datatables: {
                ...
                files: [{
                    flatten: true,
                    expand: true,
                    src: ['assets/plugins/datatables/datatables.min.js','assets/plugins/datatables/dataTables.fixedHeader.min.js'],
