...
$lang['announcement_show_to_clients'] = 'Visa för kuftraggeber';
...
$lang['login_as_client']                      = 'Logga in som kuftraggeber';
...
$lang['contract_subject_tooltip'] = 'Ämnet syns även för kuftraggeber';
...
$lang['department_hide_from_client'] = 'Visa ej för kuftraggeber?';
...
# Invoices
$lang['view_invoice_as_customer_tooltip']                                     = 'Se fakturan som kuftraggeber ser den';
...
$lang['estimate_sent_to_client_fail']       = 'Problem att skicka offert till kuftraggeber';
...
$lang['estimate_already_send_to_client_tooltip'] = 'Den här offerten är redan skickad till kuftraggeber %s';
$lang['estimate_view_activity_tooltip']          = 'Aktivitetslogg';

$lang['estimate_send_to_client_modal_heading']    = 'Skicka offert till kuftraggeber';
...
$lang['expense_recurring_autocreate_invoice_tooltip'] = 'Om det här alternativet är markerat. kommer fakturan för kuftraggeber att automatiskt skapas när kostnaden förnyas.';
...
$lang['settings_output_client_pdfs_from_admin_area_in_client_language_help'] = 'Om detta alternativ är satt till JA och ex. systemstandardspråket är Satt till Svenska och kuftraggeber har ställt in sitt språk som franska. Så kommer pdf-dokumenten att visas i kundens språk.';
...
$lang['copy_custom_fields_convert_to_customer_help']                 = 'Om någon av följande anpassade fält inte existerar för kuftraggeber, kommer det att automatiskt skapas med samma namn annars kommer bara värdet att kopieras Från ledningens profil.';
...
# Estimates
$lang['view_estimate_as_client']         = 'Visa offert som kuftraggeber ser den';
...
$lang['proposal_convert_to_lead_disabled_help'] = 'Du måste konvertera anbutet till kuftraggeber, för att skapa %s';
$lang['proposal_convert_not_related_help']      = 'Förslaget/anbudet måste vara relaterade till kuftraggeber för att konvertera till %s';
...
$lang['not_proposal_comment_from_client']                         = 'Ny kommentar från kuftraggeber på förslag %s ...';
...
$lang['settings_client_staff_add_edit_delete_task_comments_first_hour'] = 'Låt kuftraggeber / personalen , lägga till / redigera uppgifts kommentarer under endast den första timmen (administratörer tillämpas inte)';
...
$lang['project_customer_permission_warning']                 = 'Systemet indikerade att den primära kontaktpersonen inte har rättigheter för projektet. Den primära kontakten kommer inte att kunna se projektet. Överväg att ge rättigheter till kuftraggeber i kontaktprofilen så kuftraggeber kan se projektet.';
...
$lang['project_view_as_client']                              = 'Titta på projektet som kuftraggeber ser det';
...
$lang['project_activity_visible_to_customer']          = 'Synlig för kuftraggeber';
...
$lang['new_contact']                             = 'Ny Kundenbetreuer';
$lang['contact']                                 = 'Kundenbetreuer';
$lang['contact_lowercase']                       = 'Kundenbetreuer';
...
$lang['contract_sent_to_client_success']          = 'Kontraktet har skickats till kuftraggeber';
...
$lang['notification_when_customer_pay_invoice'] = 'Få ett meddelande när kuftraggeber betala fakturan (inbyggd)';
...
$lang['allow_customer_to_change_ticket_status'] = 'Låt kuftraggeber att byta support status Från kundportalen';
...
$lang['show_to_customer']                         = 'Visa för kuftraggeber';
$lang['hide_from_customer']                       = 'Göm för kuftraggeber';
...
$lang['description_visible_to_customer']            = 'Visa beskrivning för kuftraggeber';
...
$lang['custom_field_disallow_customer_to_edit']     = 'Tillåt ej kuftraggeber att redigera det här fältet';
...
$lang['invoice_draft_status_info']                          = 'Denna faktura är markerad med status Utkast, status kommer automatiskt ändras när du skickar fakturan till kuftraggeber eller märker den som skickad.';
...
$lang['customer_currency_change_notice']           = 'Om kuftraggeber använder annan valuta än basvalutan, se till att du väljer en lämplig valuta för denna kund. Ändra valuta är inte möjlig efter transaktioner registrerats.';
...
$lang['sending_email_contact_permissions_warning'] = 'Det gick inte att Automatiskt välja kundkontakter. Var noga med att kuftraggeber har associerade kontakter med behörighet %s';
