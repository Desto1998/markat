...
$aColumns = [
    '1',
    'company',
    '(SELECT count(' . db_prefix() . 'customer_admins.customer_id) FROM ' . db_prefix() . 'customer_admins WHERE ' . db_prefix() . 'customer_admins.customer_id=' . db_prefix() . 'clients.userid) as mitabeiter',
    1,
...
foreach ($rResult as $aRow) {
    ...
    $row[] = '<span style="text-align: center; display: block">' . $aRow['mitabeiter'] . '</span>';
