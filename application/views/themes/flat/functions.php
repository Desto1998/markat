...
function theme_assets()
{
    ...
    $CI->app_scripts->theme('main-js', 'assets/js/main.min.js');
    ...
    /*    $CI->app_scripts->theme(
            'theme-main-js',
            base_url($CI->app_scripts->core_file('assets/js', 'main.min.js')) . '?v=' . $CI->app_css->core_version(),
            ['common-js']
        );*/
    ...
    if (is_client_logged_in()) {
        $path = 'assets/themes/' . get_option('clients_default_theme');
    } else {
        $path = 'assets/themes/perfex';
    }
    
    $CI->app_css->theme(
        'theme-css',
        base_url($CI->app_scripts->core_file($path. '/css', 'style.css')) . '?v=' . $CI->app_css->core_version()
    );
}
